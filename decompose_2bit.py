...
Referecnes:
[1] A universal quantum circuit for two-qubit transformations with three CNOT gates
    https://arxiv.org/pdf/quant-ph/0307177.pdf 
[2] Optimal Creation of Entanglement Using a Two-Qubit Gate.
    https://arxiv.org/pdf/quant-ph/0011050.pdf
"""
import numpy as np
import cirq
from gate2 import GateSingle, GateFC, apply_on_qubit, gates_to_matrix
from gate import Gate2, su_to_gates
from linalg import orthonormal_eigensystem
from utils import cast_to_real, is_real, is_special_unitary, is_unitary
...
A = decompose_to_magic_diagonal(ran_matrix)
# print(A)
